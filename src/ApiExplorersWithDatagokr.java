...
public class ApiExplorersWithDatagokr{
    public static void main(String[] args) throws UnsupportedEncodingException {
         ...
         */
         ...
         urlBuilder.append("?" + URLEncoder.encode("ServiceKey","UTF-8") + "=").append("wFUZjEdvYfJYBfiBwcjWJwE5fNnOO3cKteIfukZ8QxlEMvyv%2BpEZUL1PMoG%2F5EeHdu3yF3QhXWTs4lWx301puA%3D%3D"); /*Service Key*/
